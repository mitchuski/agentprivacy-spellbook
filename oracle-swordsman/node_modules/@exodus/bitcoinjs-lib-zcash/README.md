# BitcoinJS Zcash (`@exodus/bitcoinjs-lib-zcash`)
[![Build Status](https://travis-ci.com/ExodusMovement/bitcoinjs-lib-forks.svg?token=QTcVjCYzbYmjmHfQpsUB&branch=zcash)](https://travis-ci.com/ExodusMovement/bitcoinjs-lib-forks)
[![JavaScript Style Guide](https://img.shields.io/badge/code_style-standard-brightgreen.svg)](https://standardjs.com)

BitcoinJS, forked to support Zcash. Does not support z-addresses, only t-addresses.

All-new test suite; not nearly as exhaustive as `bitcoinjs-lib`'s  suite. May be bugs in parts of code not used by Exodus or the tests.

Original `bitcoinjs-lib` README below:
