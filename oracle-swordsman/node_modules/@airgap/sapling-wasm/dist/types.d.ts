 ...
 */
export declare type SaplingUnsignedSpendDescription = Omit<SaplingSpendDescription, 'spendAuthSig'>;
/**
 ...
 */
export declare type SaplingPartialOutputDescription = Omit<SaplingOutputDescription, 'epk' | 'cenc' | 'cout'>;
